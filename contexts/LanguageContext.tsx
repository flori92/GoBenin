...
export const translations: Record<Language, Record<string, TranslationValue>> = {
  en: {
    ...
    no_notifications_title: "Tout est à jour",
    no_notifications_desc: "Nous vous préviendrons quand quelque chose d’important arrive.",
    price_alert: "Alerte prix",
    price_alert_set: "Alerte prix activée",
    notification_price_alert_desc: "Nous vous préviendrons si les prix baissent pour ce séjour.",
    booking_confirmed_details: "Votre réservation pour {name} est confirmée pour le {date}.",
    booking_confirmed_stay_desc: "Votre séjour à {name} commence le {date}.",
    smart_booking_title: "Hub de réservation intelligent",
    smart_booking_subtitle: "Comparez Airbnb et Booking.com en un seul endroit, avec la meilleure option mise en avant.",
    check_in: "Arrivée",
    check_out: "Départ",
    ...
    smart_reco: "Pourquoi c’est recommandé",
    value_score: "Score valeur",
    stay_dates: "Dates du séjour",
    booking_powered: "Agrégé depuis Airbnb et Booking.com.",
    flexible_checkin: "Arrivée flexible",
    best_value: "Meilleur prix",
    highest_rated: "Mieux noté",
    free_cancellation: "Annulation flexible",
    notifications_center: "Notification Center",
    notifications_paused: "Notifications paused",
    mark_all_read: "Mark all read",
    clear_all: "Clear all",
    no_notifications_title: "You're all caught up",
    no_notifications_desc: "We'll let you know when something important happens.",
    price_alert: "Set price alert",
    price_alert_set: "Price alert set",
    notification_price_alert_desc: "We’ll notify you if prices drop for this stay.",
    booking_confirmed_details: "Your booking for {name} is confirmed for {date}.",
    booking_confirmed_stay_desc: "Your stay at {name} starts on {date}.",
    smart_booking_title: "Smart Booking Hub",
    smart_booking_subtitle: "Compare Airbnb and Booking.com in one place, with the best value highlighted.",
    check_in: "Check-in",
    check_out: "Check-out",
    nights: { one: "{count} night", other: "{count} nights" },
    per_night: "per night",
    total_with_fees: "Total (fees included)",
    ...
    smart_reco: "Why it's recommended",
    value_score: "Value score",
    stay_dates: "Stay dates",
    booking_powered: "Aggregated from Airbnb and Booking.com.",
